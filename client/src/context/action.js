...
export const GET_ALLCOMPANY_ERROR = 'GET_ALLCOMPANY_ERROR'

export const COMPANY_APPROVE_REQUEST = 'COMPANY_APPROVE_REQUEST'
export const COMPANY_APPROVE_SUCCESS = 'COMPANY_APPROVE_SUCCESS'
export const COMPANY_APPROVE_ERROR = 'COMPANY_APPROVE_ERROR'
export const COMPANY_REJECT_REQUEST = 'COMPANY_REJECT_REQUEST'

export const COMPANY_REJECT_SUCCESS = 'COMPANY_REJECT_SUCCESS'

export const COMPANY_REJECT_ERROR = 'COMPANY_REJECT_ERROR'
...
export const CREATE_COMPANY_EMPLOYEE_ERROR = 'CREATE_COMPANY_EMPLOYEE_ERROR'